...
export default function MaterialsLibraryView({ selectedExam }: MaterialsLibraryViewProps) {
  ...
  const pyqBank: PYQItem[] = [
    ...
    {
      id: 'neet-ug-2019-odisha',
      exam: 'NEET',
      year: 2019,
      paperType: 'NEET UG',
      subjectName: 'Botany, Zoology, Physics & Chemistry',
      title: 'NEET UG 2019: Odisha Session Paper (Special Examination)',
      officialPaperUrl: 'https://exams.nta.ac.in/NEET/',
      officialAnswerKeyUrl: 'https://exams.nta.ac.in/NEET/',
      syllabusMapping: 'Plant Physiology, Animal Tissue, Aldehydes & Ketones, Wave Optics & Magnetism',
      verifiedNotes: 'Official special session question paper conducted for Odisha candidates post-Cyclone Fani. Excellent benchmark paper for full-length solving.'
    }
  ];
