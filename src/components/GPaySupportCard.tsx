...
export default function GPaySupportCard({ isOpen, onClose, onVoicePlay }: GPaySupportCardProps) {
  ...
  useEffect(() => {
    ...
    if (finalAmt > 0) {
      ...
      const note = `Aspirant Academy contribution`;
      
      // Standard UPI deep link
      const link = `upi://pay?pa=${encodeURIComponent(upiId)}&pn=${encodeURIComponent('Aspirant Academy')}&am=${finalAmt}&cu=INR&tn=${encodeURIComponent(note)}`;
      setUpiLink(link);
      ...
      >
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <div className="flex items-center gap-1.5">
                <h4 className="font-extrabold text-xs text-slate-800 uppercase tracking-wider font-mono">Aspirant Academy Portal</h4>
        ...
        <div className="px-5 py-3.5 bg-slate-50/50 border-t border-slate-100 flex items-center justify-between shrink-0">
          ...
          >
            ...
            <span>Aspirant Academy Notice & Board Policy</span>
          </button>
          ...
          >
            ...
            <div className="flex items-start justify-between border-b border-slate-100 pb-2.5">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[8px] font-mono text-slate-400 uppercase tracking-widest">Aspirant Academy Notice</p>
                </div>
              </div>
              <button
                onClick={() => setShowDisclaimer(false)}
            ...
            <div className="space-y-2.5 text-[11px] text-slate-600 leading-relaxed max-h-[250px] overflow-y-auto pr-1 font-sans">
              <p className="font-bold text-slate-800">
                Aspirant Academy is an independent self-guided preparation and AI educational platform dedicated to assisting public service exam students.
              </p>
